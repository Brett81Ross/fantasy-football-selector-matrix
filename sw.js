...
const FAST_SCRIPT='<script src="/fast-draft.js?v=1.3.7"></script>';
const ROSTER_SCRIPT='<script src="/roster-needs.js?v=1.3.7"></script>';
const VORP_SCRIPT='<script src="/vorp.js?v=1.3.7"></script>';
const TIER_SCRIPT='<script src="/tier-cliffs.js?v=1.3.7"></script>';
const BRAND_SCRIPT='<script src="/brand-integration.js?v=1.3.7"></script>';
...
function injectRuntime(response){
  ...
  return response.text().then(html=>{
    ...
    headers.set('x-ffm-runtime','1.3.7');
