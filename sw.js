const CACHE='ff-matrix-v1.3.1';
const CORE=['/','/index.html','/manifest.json','/fast-draft.js','/roster-needs.js','/icons/icon-192.png','/icons/favicon-96.png','/icons/ffm-mark.svg'];
...
function ensureFastDraft(response){
  ...
  return response.text().then(html=>{
    ...
    headers.set('x-ffm-runtime','1.3.1');
