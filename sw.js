...
const CORE=['/manifest.json','/splash.js','/fast-draft.js','/decision-matrix.js','/roster-needs.js','/vorp.js','/tier-cliffs.js','/brand-integration.js','/live-refresh.js','/te-fix.js','/icons/cactus-byte-studios.svg','/icons/ffm-user-logo.svg','/icons/ffm-logo-512.png','/icons/icon-192.png','/icons/favicon-96.png'];
