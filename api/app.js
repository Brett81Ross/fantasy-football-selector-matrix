...
module.exports=async function handler(req,res){
  try{
    ...
    const runtime=['fast-draft.js','special-teams.js','roster-needs.js','vorp.js','tier-cliffs.js','brand-integration.js','live-refresh.js','te-fix.js','decision-matrix.js','draft-clarity.js','version-lock.js','cactusbyte-demo.js','native-install.js','legal-links.js','draft-core/contracts.js','season-core/contracts.js','season-core/player-status.js','season-core/data-confidence.js','season-core/rest-of-season-value.js','draft-core/sleeper-provider.js','draft-core/reliability.js','draft-core/provider-session.js','season-core/provider-session.js','draft-core/roster-assignment.js','draft-core/position-intelligence.js','draft-core/flex-intelligence.js','draft-core/live-draft-view.js','season-core/roster-doctor.js','season-core/lineup-optimizer.js','season-core/waiver-assassin.js','season-core/trade-hunter.js','season-core/opponent-exploiter.js','season-core/weekly-attack-plan.js','live-draft-mode.js','draft-state-render-bridge.js','season-intelligence.js','sleeper-live-sync.js','waiver-ownership-sync.js'];
