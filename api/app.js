...
module.exports=async function handler(req,res){
  try{
    ...
    const runtime=['fast-draft.js','fantasy-draft-recovery.js','draft-recovery-ui.js','special-teams.js','roster-needs.js','vorp.js','tier-cliffs.js','brand-integration.js','live-refresh.js','te-fix.js','decision-matrix.js','version-lock.js','cactusbyte-demo.js','native-install.js'];
