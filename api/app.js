...
module.exports=async function handler(req,res){
  try{
    ...
    const runtime=['fast-draft.js','special-teams.js','roster-needs.js','league-profile.js','vorp.js','tier-cliffs.js','brand-integration.js','live-refresh.js','te-fix.js','decision-matrix.js','draft-clarity.js','version-lock.js','cactusbyte-demo.js','native-install.js','draft-core/contracts.js','draft-core/sleeper-provider.js','draft-core/reliability.js','draft-core/provider-session.js','draft-core/roster-assignment.js','draft-core/position-intelligence.js','draft-core/flex-intelligence.js','draft-core/live-draft-view.js','live-draft-mode.js','draft-state-render-bridge.js','sleeper-live-sync.js'];
